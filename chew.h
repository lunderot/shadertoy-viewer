...
CHEWTYPEDEF( void, glBindFragDataLocation, , (program,color,name), GLuint program, GLuint color, const GLchar *name)
CHEWTYPEDEF( GLint, glGetAttribLocation, , (program,name), GLuint program, const GLchar *name)
